...
// * @author geev
// */
//public class MatTripwire extends Serializer implements ISerializer {
//
//    public static boolean isType(Block block) {
//        return block.getState().getData() instanceof org.bukkit.material.Tripwire;
//    }
//
//    public MatTripwire(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
