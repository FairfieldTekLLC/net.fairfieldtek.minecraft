...
// * @author geev
// */
//public class MatEnchantingTable  extends Serializer implements ISerializer {
//     
//      public static boolean isType(Block block) {
//        return block.getState() instanceof org.bukkit.block.EnchantingTable;
//    }
//    public MatEnchantingTable(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
