 ...
 * @author geev
 */
public class MatHopper  extends Serializer implements ISerializer {
    public static boolean isType(Block block) {
        return block.getState().getData() instanceof org.bukkit.material.Hopper;
    }

    private int FacingIdx;

    public MatHopper(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
        ...
        org.bukkit.material.Hopper d = (org.bukkit.material.Hopper)block.getState().getData();
        org.bukkit.block.Hopper dd = (org.bukkit.block.Hopper)block.getState();
