 ...
 * @author geev
 */
public class MatTorch extends Serializer implements ISerializer {
    ...
    public MatTorch(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
        super(block, xOffset, yOffset, zOffset, schematicDef);
          if (!isType(block)) {
            throw new RuntimeException("Invalid Type");
        }
          
        org.bukkit.material.Torch t = (org.bukkit.material.Torch)block.getState().getData();
