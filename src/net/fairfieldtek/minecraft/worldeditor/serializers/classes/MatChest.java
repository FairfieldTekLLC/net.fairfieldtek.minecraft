 ...
 * @author geev
 */
public class MatChest extends Serializer implements ISerializer {


    public static boolean isType(Block block) {
        return (block.getState().getData() instanceof org.bukkit.material.Chest);
    }
    private int FacingIdx;

    public MatChest(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
