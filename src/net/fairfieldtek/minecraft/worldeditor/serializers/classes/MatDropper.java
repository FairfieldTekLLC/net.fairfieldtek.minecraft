...
///**
// *
// * apparently dropper and dispenser use the same material definition.
// * @author geev
// */
//public class MatDropper extends Serializer implements ISerializer {
//    public static boolean isType(Block block) {
//        return block.getState() instanceof org.bukkit.block.Dropper;
//    }
//
//    private int FacingIdx;
//    public MatDropper(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
...
//        org.bukkit.material.Dispenser dd = (org.bukkit.material.Dispenser) block.getState().getData();
//        setFacing(dd.getFacing());
//        
//    }
//
