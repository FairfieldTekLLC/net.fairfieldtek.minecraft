...
// * @author geev
// */
//public class MatTree  extends Serializer implements ISerializer {
//    public static boolean isType(Block block) {
//        return block.getState().getData() instanceof org.bukkit.material.Tree;
//    }
//     private int FacingIdx;
//     private int TreeSpeciesIdx;
//     public MatTree(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
//         super(block, xOffset, yOffset, zOffset, schematicDef);
//         if (!isType(block)) {
//             throw new RuntimeException("Invalid Type");
//         }
//         
//         org.bukkit.material.Tree t = (org.bukkit.material.Tree)block.getState().getData();
//         setFacing(t.getDirection());
