...
// * @author geev
// */
//public class MatVine  extends Serializer implements ISerializer {
//    public static boolean isType(Block block) {
//        return block.getState().getData() instanceof org.bukkit.material.Vine;
//    }
//    private int FacingIdx;    
//    public MatVine(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
...
//        }
//
//        org.bukkit.material.Vine t = (org.bukkit.material.Vine)block.getState().getData();
