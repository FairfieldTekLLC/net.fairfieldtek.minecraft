...
// * @author geev
// */
//public class MatEnderChest   extends Serializer implements ISerializer {
//    public static boolean isType(Block block) {
//        return block.getState() instanceof org.bukkit.block.EnderChest;
//    }
//    
//     private int FacingIdx;
//     public MatEnderChest(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
...
//         org.bukkit.material.EnderChest ec1 = (org.bukkit.material.EnderChest)block.getState().getData();
//         
//         setFacing (ec1.getFacing());
//         
//         
//     }
//
