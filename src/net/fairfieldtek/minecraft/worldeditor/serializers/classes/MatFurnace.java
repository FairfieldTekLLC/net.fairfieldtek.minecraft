...
// * @author geev
// */
//public class MatFurnace extends Serializer implements ISerializer {
//
//    public static boolean isType(Block block) {
//        return block.getState() instanceof org.bukkit.block.Furnace;
//    }
//    private int FacingIdx;
//    public MatFurnace(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
//        super(block, xOffset, yOffset, zOffset, schematicDef);
//        
//        org.bukkit.material.Furnace f = (org.bukkit.material.Furnace) block.getState().getData();
//        setFacing(f.getFacing());
//        org.bukkit.block.Furnace ff = (org.bukkit.block.Furnace) block.getState();
//        
//    }
//
