 ...
 * @author geev
 */
public class MatSmoothBrick extends Serializer implements ISerializer {
    public static boolean isType(Block block) {
        return block.getState().getData() instanceof org.bukkit.material.SmoothBrick;
    }

    private int MaterialIdx;
    public MatSmoothBrick(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
        super(block, xOffset, yOffset, zOffset, schematicDef);
        
        org.bukkit.material.SmoothBrick t = (org.bukkit.material.SmoothBrick) block.getState().getData();
        //org.bukkit.material.TexturedMaterial tt = (org.bukkit.material.TexturedMaterial)block.getState().getData();
