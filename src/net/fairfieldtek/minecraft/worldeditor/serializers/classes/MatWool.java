...
// * @author geev
// */
//public class MatWool extends Serializer implements ISerializer {
//    public static boolean isType(Block block) {
//        return block.getState().getData() instanceof org.bukkit.material.Wool;
//    }
//
//    private int DyeColor;
//    public MatWool(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
//        super(block, xOffset, yOffset, zOffset, schematicDef);
//
//        if (!isType(block)) {
//            throw new RuntimeException("Invalid Type");
//        }
//        org.bukkit.material.Wool t = (org.bukkit.material.Wool) block.getState().getData();
//        setColor(t.getColor());
//        
//    }
//
