...
// * @author geev
// */
//public class MatButton extends Serializer implements ISerializer {
//    public static boolean isType(Block block) {
//        return (block.getState().getData() instanceof  org.bukkit.material.Button);
//    }
//
//    private int FacingIdx;
//    public MatButton(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
//        super(block, xOffset, yOffset, zOffset, schematicDef);
//        if (!isType(block)) {
//            throw new RuntimeException("Invalid Type");
//        }
//
//        org.bukkit.material.Button mButton = (org.bukkit.material.Button) block.getState().getData();
//        setFacing(mButton.getAttachedFace());
//        
//    }
//
