 ...
 * @author geev
 */
public class MatFence  extends Serializer implements ISerializer {
    public static boolean isType(Block block) {
        return block.getType().name().endsWith("_FENCE");
    }

    public MatFence(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
