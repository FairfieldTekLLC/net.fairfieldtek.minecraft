...
// * @author geev
// */
//public class MatGate extends Serializer implements ISerializer {
//    public static boolean isType(Block block) {
//        return block.getType().name().endsWith("_GATE");
//    }
//
//    private int FacingIdx;
//    public MatGate(Block block, int xOffset, int yOffset, int zOffset, net.fairfieldtek.minecraft.worldeditor.container.SchematicDef schematicDef) {
...
//        org.bukkit.material.Gate gate = (org.bukkit.material.Gate) sMat;
//
//        setFacing(gate.getFacing());
//        
//    }
//
