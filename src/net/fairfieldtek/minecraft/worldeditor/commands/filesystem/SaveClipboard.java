    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            try {
                ...
                new SaveClipboardTaskRequest(player.getUniqueId().toString(), pi.getLastAuth(), pi.getCurrentPath(), pi.ClipSchematic, args[0]).runTaskAsynchronously((org.bukkit.plugin.Plugin) Initialization.Plugin);
            } catch (Exception e) {
