...
//                PluginManager.PlayerInfoList.get(player.getUniqueId()).setIsProcessing(false, "SaveClipboard");
//                player.sendMessage(ChatColor.GREEN + "File Saved.");
//                this.cancel();
//                return;
//            }
//            PluginManager.PlayerInfoList.get(player.getUniqueId()).setLastAuth(this.Response.getAuth());
//
