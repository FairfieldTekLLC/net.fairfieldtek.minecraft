...
import com.Blockelot.worldeditor.commands.tasks.MappingTask;
 ...
 * @author geev
 */
public class MapTheWorld implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            if (args.length == 1) {
                ...
                MappingTask pt = new MappingTask(pi, n);

                player.sendMessage("Starting Mapping Process for " + n);

                pt.runTaskTimer((org.bukkit.plugin.Plugin) PluginManager.Plugin, 1, 15);
                return true;
            } else {
